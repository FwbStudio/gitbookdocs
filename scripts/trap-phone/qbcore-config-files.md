...
Config.Dispatch = {
    enable = false,-- if u want to use it then put your export into /client/unlocked.lua   --its a client side function
...
Config.Account = 'cash'           -- cash,bank,black_money,markedbills
